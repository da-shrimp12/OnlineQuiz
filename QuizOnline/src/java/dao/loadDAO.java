...
public class loadDAO {
	...
	public void editQuiz(String question, String option1, String option2, String option3,
			String option4, String answer, String date, int userId, int id)  {
		Connection conn = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		String query = "update quiz \n"
				+ "set [question] = N'" + question + "',\n"
				+ "[option1] = N'" + option1 + "',\n"
				+ "[option2] = N'" + option2 + "',\n"
				+ "[option3] = N'" + option3 + "',\n"
				+ "[option4] = N'" + option4 + "',\n"
	...
	public static void main(String[] args) {
		try {
			...
			dao.editQuiz("năm", "mới3", "zui", "zẻ", "nha", "1 3", "2021-07-12", 1001, 4069);
		} catch (Exception e) {
		}
